...
function initializeLogger() {
  return _initializeLogger.apply(this, arguments);
}
function _initializeLogger() {
  _initializeLogger = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return _promises["default"].mkdir('src/temp/logs', {
            recursive: true
          });
        case 2:
...
var logger = _winston["default"].createLogger({
  ...
  }), _config["default"].NODE_ENV === 'development' ? colorize() : _winston["default"].format.simple(), customFormat),
...
process.on('warning', function (warning) {
  logger.warn("Process warning: ".concat(warning.name), {
