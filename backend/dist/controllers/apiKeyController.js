  ...
  return _createClass(ApiKeyController, [{
    ...
    value: function encryptKey(text) {
      try {
        ...
        _logger["default"].error('Šifrování klíče selhalo', {
          error: error
        });
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            ...
            case 26:
              ...
              _logger["default"].error('Chyba při vytváření klíče:', _context.t0);
      ...
      var _resetKey = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 7:
              newApiKey = _crypto["default"].randomBytes(32).toString('hex');
            ...
            case 19:
              ...
              _logger["default"].error('Chyba v resetKey', {
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            ...
            case 19:
              ...
              _logger["default"].error('Chyba v forgotKey', {
        ...
        return _regeneratorRuntime().wrap(function _callee4$(_context4) {
          while (1) switch (_context4.prev = _context4.next) {
            case 0:
              ...
              _logger["default"].warn('Chybějící API klíč v požadavku');
            ...
            case 10:
              ...
              _logger["default"].warn('Pokus o ověření neplatného klíče', {
                apiKey: apiKey
              });
            ...
            case 14:
              _logger["default"].debug('API klíč ověřen', {
                apiKey: apiKey
              });
              res.json({
                success: true
            ...
            case 18:
              ...
              _logger["default"].error('Chyba při ověřování API klíče', {
        ...
        return _regeneratorRuntime().wrap(function _callee5$(_context5) {
          while (1) switch (_context5.prev = _context5.next) {
            case 0:
              ...
              encryptedKey = _assertClassBrand(_ApiKeyController_brand, this, _encrypt).call(this, apiKey);
              _context5.next = 4;
              return _ApiKey["default"].updateOne({
                apiKey: encryptedKey
              }, {
                $inc: {
                  usageCount: 1
            ...
            case 4:
              _logger["default"].debug('Sledování použití API klíče', {
                apiKey: apiKey
              });
              _context5.next = 10;
              break;
            case 7:
              ...
              _logger["default"].error('Chyba při sledování použití API klíče', {
...
function _encrypt(text) {
  var cipher = _crypto["default"].createCipheriv('aes-256-cbc', _classPrivateFieldGet(_encryptionKey, this), _classPrivateFieldGet(_iv, this));
  var encrypted = cipher.update(text, 'utf8', 'hex');
  encrypted += cipher["final"]('hex');
  return encrypted;
}
function _decrypt(encryptedText) {
  var decipher = _crypto["default"].createDecipheriv('aes-256-cbc', _classPrivateFieldGet(_encryptionKey, this), _classPrivateFieldGet(_iv, this));
...
function _handleError(error, res, context) {
  ...
  _logger["default"].error("Chyba API Key Controller (".concat(context, ")"), {
    error: error.message,
    stack: error.stack
  });
...
var _default = exports["default"] = apiKeyControllerInstance;