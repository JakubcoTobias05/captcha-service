...
var NoCaptcha = /*#__PURE__*/function () {
  function NoCaptcha() {
    ...
    this.CAPTCHA_TTL = _config["default"].captchaTTL;
    this.MIN_MOVEMENTS = ((_config$noCaptcha = _config["default"].noCaptcha) === null || _config$noCaptcha === void 0 ? void 0 : _config$noCaptcha.minMouseMovements) || 5;
    this.MIN_CLICKS = ((_config$noCaptcha2 = _config["default"].noCaptcha) === null || _config$noCaptcha2 === void 0 ? void 0 : _config$noCaptcha2.minClicks) || 1;
    this.MIN_TIME = ((_config$noCaptcha3 = _config["default"].noCaptcha) === null || _config$noCaptcha3 === void 0 ? void 0 : _config$noCaptcha3.minInteractionTime) || 500;
  }
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              challenge = {
                createdAt: Date.now(),
                secret: _crypto["default"].randomBytes(16).toString('hex')
              };
              _context.next = 5;
              return _redisClient["default"].set("captcha:nocaptcha:".concat(token), JSON.stringify(challenge), {
                EX: this.CAPTCHA_TTL
              });
            case 5:
            ...
            case 8:
              ...
              _logger["default"].error('NoCAPTCHA generation failed', {
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            case 0:
              _context2.prev = 0;
              if (interactionData) {
                _logger["default"].debug("NoCAPTCHA - Přijatá interakční data:", JSON.stringify(interactionData, null, 2));
              } else {
                _logger["default"].debug("NoCAPTCHA - žádná interakční data přijata");
              }
              _context2.next = 4;
              return _redisClient["default"].get("captcha:nocaptcha:".concat(token));
            case 4:
              ...
              _logger["default"].warn('Neplatný nebo expirovaný token', {
                token: token
              });
            ...
            case 8:
              ...
              _logger["default"].debug('NoCAPTCHA - Validation input check failed');
              return _context2.abrupt("return", false);
            case 13:
              ...
              _context2.next = 16;
              return _redisClient["default"].del("captcha:nocaptcha:".concat(token));
            case 16:
              _logger["default"].info('NoCAPTCHA verification', {
                token: token,
            ...
            case 20:
              ...
              _logger["default"].error('NoCAPTCHA verification failed', {
                token: token,
...
function _analyzeBehavior(mouseTrail, clickTimestamps, startTime, endTime, secret) {
  ...
  if (totalTime < this.MIN_TIME) {
    _logger["default"].debug("NoCAPTCHA - totalTime ".concat(totalTime, "ms < MIN_TIME ").concat(this.MIN_TIME, "ms"));
    return false;
  }
  ...
  _logger["default"].debug('NoCAPTCHA - analyzeBehavior results:', {
    totalTime: totalTime,
...
function _calculateMovementScore(mouseTrail) {
  ...
  _logger["default"].debug('NoCAPTCHA - movementScore calculation:', {
    distance: distance,
...
function _calculateClickScore(clickTimestamps, startTime, endTime) {
  ...
  _logger["default"].debug('NoCAPTCHA - clickScore calculation:', {
...
var _default = exports["default"] = new NoCaptcha();